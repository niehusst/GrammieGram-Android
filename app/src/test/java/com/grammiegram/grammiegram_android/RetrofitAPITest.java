...
public class RetrofitAPITest {
    ...
    public void updatingSettingsSuccessTest() throws IOException {
        ...
        Call<UpdateSettingsResponse> update = mockAPI.updateSettings("Token 123", "turkey", true);
    ...
    public void updateSettingsFailureTest() throws IOException {
        ...
        Call<UpdateSettingsResponse> update = mockAPI.updateSettings("Token 123", "None", false);
        Response<UpdateSettingsResponse> response = update.execute();
